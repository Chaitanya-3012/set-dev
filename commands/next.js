const NextSetup = () => {
    return {
        ...
        commands: {
            "vanilla-next": "npx create-next-app@latest .",
            "next-ts": "npx create-next-app@latest . --ts",
            "next-appdir": "npx create-next-app@latest . --ts --app",
            "next-3js": "npx create-next-app@latest . && npm install three @types/three",
            "next-mui": "npx create-next-app@latest . && npm install @mui/material @emotion/react @emotion/styled @mui/icons-material",
            "next-shadcn": "npx create-next-app@latest . && npm install lucide-react && npx shadcn@latest init",
            "next-redux": "npx create-next-app@latest . && npm install @reduxjs/toolkit react-redux",
            "next-tailwind": "npx create-next-app@latest . && npm install -D tailwindcss postcss autoprefixer && npx tailwindcss init -p",
            "next-auth": "npx create-next-app@latest . && npm install next-auth",
        },
        "additional-packages": {
